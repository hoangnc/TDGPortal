...
namespace TDG.STS.IdentityServer.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update IdentityServerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update IdentityServerEfCoreEntityExtensionMappings to extend the IdentityUser entity
