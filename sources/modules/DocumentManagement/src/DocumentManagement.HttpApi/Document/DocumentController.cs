...
namespace DocumentManagement.Document
{
    ...
    public class DocumentController : DocumentManagementController, IDocumentAppService
    {
        ...
        [HttpGet]
        [Route("filteredpagedlist-by-documenttype")]
        ...
        [HttpGet]
        [Route("filteredpagedlist-by-departmentcode")]
