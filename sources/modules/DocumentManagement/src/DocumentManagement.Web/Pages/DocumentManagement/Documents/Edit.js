...
(function () {
    ...
    const updateAndReleaseDocumentApiPath = '/api/document-management/documents/updateandrelease';
    const updateDocumentApiPath = '/api/document-management/documents/update';
    const deleteDocumentFileApiPath = '/api/document-management/documents/deletefile';
