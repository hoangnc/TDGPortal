    ...
    $(function () {
        ...
        function initGrdDocument() {
            ...
            grdDocument = new Tabulator("#grdDocument", {
                ...
                ajaxSorting: false,
                ajaxLoader: true,
                ajaxURL: '/api/document-management/documents/filteredpagedlist-by-departmentcode',
                                    ...
                                    if (fileNames.length > 0) {
                                        ...
                                        for (let index = 0; index < fileNames.length; index++) {
                                            if (fileNames[index]) {
                                                ...
                                                html = html + `<a target="_blank" href="/api/document-management/filemanager/viewfile?sourceDoc=${filePath}"> <i class="${fileIcon}"></i> ${fileNames[index]}</a><br>`;
                                            }
                                        }
                                    }
                                }
                                    ...
                                    if (appendixes.length > 0) {
                                        for (let index = 0; index < appendixes.length; index++) {
                                            if (appendixes[index]) {
                                                ...
                                                html = html + `<a target="_blank" href="/api/document-management/filemanager/viewfile?sourceDoc=${filePath}"> <i class="${fileIcon}"></i> ${appendixes[index].fileName}</a><br>`;
                                            }
                                        }
                                    }
                                }
